    ...
    <>
     ...
     <div className='ask-ques-container'>
      ...
      <label htmlFor='ask-ques-title'>
       ...
       placeholder="e.g. Is there an R function for finding the index of an element in a vector?" id='ask-ques-title'/>
      </label>
      ...
      <label htmlFor='ask-ques-tags'>
       ...
       <input type='text'  onChange={(e) => {
                 ...
                 placeholder="e.g. (xml typescript wordpress)" id='ask-ques-tags'/>
      </label>
      </div>
